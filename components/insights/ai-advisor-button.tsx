...
export default function AIAdvisorButton({ applications }: AIAdvisorButtonProps) {
  ...
  return (
    <div className="flex items-center gap-6">
      ...
      <button
        onClick={handleClick}
        className="group relative w-12 h-12 rounded-xl bg-background/40 backdrop-blur-md border border-primary/20 shadow-lg hover:shadow-xl hover:border-primary/40 transition-all duration-300 flex items-center justify-center animate-bounce hover:animate-none"
      >
